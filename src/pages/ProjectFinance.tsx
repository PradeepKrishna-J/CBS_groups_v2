      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif mb-8 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
            <span className="block text-gray-900">Project Finance</span>
          </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">₹10Cr+</div>
              <div className="text-sm text-gray-600">Maximum Loan Amount</div>
            </div>
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">11.5%</div>
              <div className="text-sm text-gray-600">Interest Rate Starting</div>
            </div>
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">7days</div>
              <div className="text-sm text-gray-600">Approval Time</div>
            </div>
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">120mo</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif mb-6 text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>
              Key Features of Our Project Finance
            </h2>
            <p className="text-lg text-gray-600">
              Comprehensive funding solutions for large-scale projects
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              'Project finance up to ₹10+ Crore',
              'Long tenure up to 10 years',
              'Competitive rates starting from 11.5% p.a.',
              'Structured repayment plans',
              'Suitable for infrastructure & manufacturing',
              'Technical and financial evaluation support'
            ].map((feature, index) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 relative">
              {[
                { step: '1', title: 'Submit Application', desc: 'Fill out online form with project details', icon: '📝', delay: '0.1s' },
                { step: '2', title: 'Documentation', desc: 'Upload project report and documents', icon: '📄', delay: '0.2s' },
                { step: '3', title: 'Evaluation', desc: 'Technical and financial assessment', icon: '✓', delay: '0.3s' },
