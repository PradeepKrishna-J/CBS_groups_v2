      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif mb-8 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
            <span className="block text-gray-900">Working Capital Loans</span>
          </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">₹3Cr+</div>
              <div className="text-sm text-gray-600">Maximum Loan Amount</div>
            </div>
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">10.5%</div>
              <div className="text-sm text-gray-600">Interest Rate Starting</div>
            </div>
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">48hrs</div>
              <div className="text-sm text-gray-600">Approval Time</div>
            </div>
            <div className="p-6 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/50 shadow-lg">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">36mo</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Flexible financing to meet your day-to-day business needs
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              'Working capital up to ₹3 Crore',
              'Flexible tenure from 12 to 36 months',
              'Competitive rates starting from 10.5% p.a.',
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 relative">
              {[
                ...
                { step: '3', title: 'Quick Approval', desc: 'Get approval within 48 hours', icon: '✓', delay: '0.3s' },
